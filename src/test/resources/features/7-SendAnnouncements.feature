@sendingAnnouncements
Feature:
  Agile Story: 7
  As a user, I should be able to send annoucement from Annoucement subheadding
  from "More" under Activity Stream.
 ...
 Given user is on the portal page
    When user clicks on tag icon in the message box
    Then user should be able to tag users from the "<list>"
